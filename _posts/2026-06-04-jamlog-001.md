...
With that out of the way: I started Jam chasing mutable value semantics, a drop system, and safety without a garbage collector. The jamlog posts are where I get to talk about what it's actually like to live in the language.
